...
<div id="main-wrapper">
    ...
    <!--**********************************
        Nav header start
    ***********************************-->
    <div class="nav-header bg-warning justify-content-center d-flex">
        <img class="img-fluid " src="{{ asset('logo-big.png') }}" alt="">
    </div>
    <!--**********************************
        Nav header end
    ***********************************-->
                                ...
                                <ul>
                                    ...
                                    <li>
                                        <form id="logout-form" action="{{ route('logout') }}" method="POST">
                                            @csrf
                                            <button type="submit"
                                                    class="btn shadow-none border-0 bg-transparent text-dark c-pointer pl-0">
    ...
    <div class="nk-sidebar">
        <div class="nk-nav-scroll">
            <ul class="metismenu" id="menu">
                ...
                <li>
                    <a href="{{ route('translate.jobs') }}" aria-expanded="false">
                        <i class="fa fa-quora"></i><span class="nav-text">Translate Jobs</span>
                    </a>
                </li>
                <li>
                    <a href="{{ route('translate.library') }}" aria-expanded="false">
