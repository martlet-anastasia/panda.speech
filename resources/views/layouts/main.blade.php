...
<aside class="sidenav navbar navbar-vertical navbar-expand-xs border-0 border-radius-xl my-3 fixed-start ms-3 " id="sidenav-main">
    ...
    <div class="collapse navbar-collapse  w-auto  max-height-vh-100 h-100" id="sidenav-collapse-main">
        <ul class="navbar-nav">
            ...
            <li class="nav-item">
                <a class="nav-link @if(Route::currentRouteName() == "all_files") active @endif" href="{{ route('home') }}">
                    <div class="@if(Route::currentRouteName() == "all_files") bg-icon text-white @else bg-white @endif p-2 shadow border-radius-md text-center me-2 d-flex align-items-center justify-content-center">
